...
class DeepLabV3Plus(nn.Module):
    ...
    def forward(self, x):
        with ExitStack() as stack:
            ...
            x = self.aspp(c4)
        return [c0, c1, c2, c3, c4], x


class _SkipProject(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer=nn.BatchNorm2d):    # 64，32，nn.BatchNorm2d
...
class _DeepLabHead(nn.Module):
    def __init__(self, out_channels, in_channels, mid_channels=256, norm_layer=nn.BatchNorm2d):    # out:256, in:256+32, mid:256
